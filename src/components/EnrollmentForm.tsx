...
const NPA_EVENTO_ID = "56a3a294-7ba9-49c6-80a3-c2a144338cf2";

type TurmaOption = "26set_manha" | "26set_tarde" | null;
...
const TURMA_CONFIG = {
  "26set_manha": {
    ...
    endereco: "R. Maj. Antônio Domingues, 84 - Centro, São José dos Campos - SP",
    ...
    try {
      ...
      fetch(`${SUPABASE_URL}/functions/v1/npa-lead-create`, {
        ...
        body: JSON.stringify({
          ...
          turma: selectedTurma === "26set_manha" ? "manha" : "tarde",
        }),
      }).catch((err) => console.error("Erro ao salvar no CRM:", err));

      const eventId = `npa_lp_sjc_${Date.now()}_${Math.random().toString(36).substr(2, 5)}`;
      ...
      <div className="space-y-5">
        ...
        <div>
          <Label className="text-foreground font-medium flex items-center gap-2 mb-3">
            ...
            Escolha sua turma - 26 de Setembro
          </Label>
